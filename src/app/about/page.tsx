...
import {SectionTitle} from '../components/maincomponent/SectionTitle';
import ChefCard from '../components/maincomponent/ChefCard';
import Footer from '../components/layout/Footer';
import { FaUtensils, FaBoxOpen, FaTruck } from 'react-icons/fa'; 
import MainButton from '../components/maincomponent/Button';
    ...
    <>
      ...
      <section className="relative h-[70vh] flex items-center justify-center text-white px-4 overflow-hidden">
        ...
        <div className="relative z-10 text-center">
            <h1 className="text-[160px] font-normal drop-shadow-lg font-sans tracking-[20px]"> About Us</h1>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-12 items-center">
            <div className="text-center lg:text-left">
              <p className="text-base md:text-lg leading-relaxed text-gray-300 mb-6">
                ...
                is not simply random text. It has roots in a piece of cLatin literature from 45 BC. Contrary to popular belief, Lorem Ipsum
                ...
                in a piece of classical Latin literature from 45 BC.Latin literature from 45 BC. Contrary to popular belief, Lorem Ipsum
                is not simply random text. It has roots in a piece of classical Latin literature from
                45 BC. Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots
                in a piece of classical Latin literature from 45 BC.lassical Latin literature from
                45 BC.
              </p>
              <p className="text-base md:text-lg leading-relaxed text-gray-300">
                It was popularised in the 1960s with the release of Letraset shLatin literature from 45 BC. Contrary to popular belief, Lorem Ipsum
                is not simply random text. It has roots in a piece of classical Latin literature from
                45 BC. Contrary to popular belief
...
<section className="relative bg-[#0B1517] py-80 sm:py-28">
  ...
  {/* <div className="hidden lg:block absolute -top-45 -right-20 z-10 pointer-events-none"> */}
    ...
    <MainButton onClick={handleContactClick} text="CONTACT US" ariaLabel="Contact Us" />
  </div>
</section>
